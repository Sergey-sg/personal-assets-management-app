...
export class initialInvoiceTable1664555212277 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "avatarPath" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "refreshTokenHash" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "refreshTokenHash" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "wallet" ADD "status" "public"."wallet_status_enum" NOT NULL DEFAULT 'open'`);
        await queryRunner.query(`ALTER TABLE "wallet" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "wallet" ADD "currency" "public"."wallet_currency_enum" NOT NULL DEFAULT 'UAH'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "wallet" DROP COLUMN "currency"`);
        await queryRunner.query(`ALTER TABLE "wallet" ADD "currency" character varying(50) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "wallet" DROP COLUMN "status"`);
        await queryRunner.query(`ALTER TABLE "wallet" ADD "status" character varying(50) NOT NULL DEFAULT 'open'`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "refreshTokenHash" SET DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "refreshTokenHash" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "avatar_path" character varying NOT NULL DEFAULT ''`);
